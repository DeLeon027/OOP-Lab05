...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
         ...
         */
        final Product p1 = new ComparableProduct("Sonnifero", 10);
        final Product p2 = new ComparableProduct("Abecedario", 90);
        final Product p3 = new ComparableProduct("Draghi", 2);
